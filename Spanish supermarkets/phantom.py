...
def setting_webdriver():
    ...
    proxies = [
        '--proxy-server="145.239.85.58:9300"',
        '--proxy-server="46.4.96.137:1080"',
        '--proxy-server="47.91.88.100:1080"',
        '--proxy-server="45.77.56.114:30205"',
        '--proxy-server="#82.196.11.105:1080"',
        '--proxy-server="51.254.69.243:3128"',
        '--proxy-server="185.153.198.226:32498"',
        '--proxy-server="83.77.118.53:17171"',
        '--proxy-server="173.192.21.89:80"',
        '--proxy-server="5.199.171.227:3128"',
    ]

    options = webdriver.ChromeOptions()
    # options.add_argument(random.choice(proxies))
    ...
    print('User-agent used:', driver.execute_script("return navigator.userAgent;"))
    return driver